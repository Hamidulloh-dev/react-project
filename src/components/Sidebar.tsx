    ...
    return <aside className="flex flex-col justify-between items-center bg-[#FFFFFF] shadow-sm w-[200px] h-[1265px] rounded-xl">
        ...
        <div className="space-y-10 mb-10">
            <div className="flex justify-center w-[168px] h-[168px] bg-[#EBF3FF] rounded-2xl relative overflow-visible">
                ...
                <button
                    className="support flex text-white bg-[#3F8CFF] px-4 rounded-xl py-2 items-center gap-2 absolute top-24 font-medium">
                    <TbMessageCircle className="w-6 h-6" />
                    <span>Support</span>
                </button>
            </div>
            <button className="logout flex items-center gap-3 text-[#7D8592] font-medium pl-2">
